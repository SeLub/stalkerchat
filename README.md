...
- ✅ **Локальное хранение**: IndexedDB (Dexie.js) для сообщений, контактов и ключей
...
### В разработке
- 🔄 **Настоящее E2EE**: Signal Protocol интеграция
- 🔄 **Медиа сообщения**: Загрузка файлов в S3
- 🔄 **Seed-фраза**: Восстановление аккаунта через 24 слова
...
- [x] **Локальное хранение сообщений**: IndexedDB с автоочисткой и лимитами
- [x] **Шифрование приватных ключей**: AES-GCM в IndexedDB
- [ ] Настоящее E2EE шифрование сообщений (Signal Protocol)
- [ ] Seed-фраза для восстановления аккаунта
