...
- **Sonner** — уведомления
- **SQLite** — локальное хранение (планируется: `absurd-sql`)
...
- ✅ **UI/UX**: Telegram-подобный интерфейс, темная/светлая тема
...
### В разработке
- 🔄 **Локальное хранение**: absurd-sql + SQLite для истории сообщений
...
- [ ] Локальное хранение сообщений (SQLite)
- [ ] Настоящее E2EE шифрование
